...
<?php
  ...
  ?>
    ...
    <input class="input-edithanghoa" style="margin-left:70px" type="text" value="<?php if($ac == 1) {echo $mausac;}else if($ac == 2) {echo '';} ?>" name="mausac"> <br>
    

    <label for="">Size</label>
    <input class="input-edithanghoa" style="margin-left:95px" type="text" class="form-control" value="<?php if($ac == 1) {echo $size;}else if($ac == 2) {echo '';} ?>" name="size"> <br>
